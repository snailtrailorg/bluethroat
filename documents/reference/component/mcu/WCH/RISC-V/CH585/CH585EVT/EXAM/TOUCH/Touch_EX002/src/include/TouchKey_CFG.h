...
#define TKY_CHS_INIT \
				GEN_TKY_CH_INIT( TKY_QUEUE_0,  0, 1, 3, 0, 3382, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_1, 10, 2, 3, 0, 3223, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_2,  8, 2, 3, 0, 3621, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_3,  6, 2, 3, 0, 3600, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_4,  1, 1, 3, 0, 3360, 150, 120 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_5,  9, 2, 3, 0, 3233, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_6,  7, 2, 3, 0, 3604, 130, 100 ),\
				GEN_TKY_CH_INIT( TKY_QUEUE_7,  5, 2, 3, 0, 3214, 130, 100 )
