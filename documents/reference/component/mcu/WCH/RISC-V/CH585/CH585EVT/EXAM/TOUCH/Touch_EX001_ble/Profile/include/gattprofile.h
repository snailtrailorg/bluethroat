 ...
 */
extern bStatus_t simpleProfile_Notify2(uint16_t connHandle, attHandleValueNoti_t *pNoti);
/*
 * simpleProfile_Notify - Send notification.
 *
 *    connHandle - connect handle
 *    pNoti - pointer to structure to notify.
 */
extern bStatus_t simpleProfile_Notify3(uint16_t connHandle, attHandleValueNoti_t *pNoti);
/*
 * simpleProfile_Notify - Send notification.
 *
 *    connHandle - connect handle
 *    pNoti - pointer to structure to notify.
 */
extern bStatus_t simpleProfile_Notify4(uint16_t connHandle, attHandleValueNoti_t *pNoti);
