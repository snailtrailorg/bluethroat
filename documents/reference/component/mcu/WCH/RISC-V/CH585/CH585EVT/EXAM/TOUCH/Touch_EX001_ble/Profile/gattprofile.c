...
#define SIMPLEPROFILE_CHAR3_VALUE_POS 9
...
static uint8_t simpleProfileChar3Props = GATT_PROP_NOTIFY;//GATT_PROP_WRITE;
...
// Client Characteristic Configuration only shows the configuration for
// that client and writes only affect the configuration of that client.
static gattCharCfg_t simpleProfileChar3Config[4];
 ...
 * @return      Success or Failure
 */
bStatus_t simpleProfile_Notify2(uint16_t connHandle, attHandleValueNoti_t *pNoti)
{
 ...
 * @return      Success or Failure
 */
bStatus_t simpleProfile_Notify3(uint16_t connHandle, attHandleValueNoti_t *pNoti)
{
 ...
 * @return      Success or Failure
 */
bStatus_t simpleProfile_Notify4(uint16_t connHandle, attHandleValueNoti_t *pNoti)
{
