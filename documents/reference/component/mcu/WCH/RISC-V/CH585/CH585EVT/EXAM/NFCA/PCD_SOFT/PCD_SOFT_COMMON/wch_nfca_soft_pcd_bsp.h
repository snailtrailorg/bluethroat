...
#ifndef _WCH_NFCA_SOFT_PCD_BSP_H_
#define _WCH_NFCA_SOFT_PCD_BSP_H_

#include "wch_nfca_soft_pcd_config.h"
...
#define NFCA_PCD_MAX_SEND_NUM           (32)
#define NFCA_PCD_MAX_RECV_NUM           (NFCA_PCD_MAX_SEND_NUM)
 ...
 * @return          None.
 */
extern void nfca_soft_pcd_init(void);
 ...
 */
extern nfca_pcd_controller_state_t nfca_soft_pcd_wait_communicate_end(void);
...
#endif /* _WCH_NFCA_SOFT_PCD_BSP_H_ */
