/********************************** (C) COPYRIGHT *******************************
 * File Name          : wch_nfca_soft_pcd_config.h
 * Author             : WCH
 * Version            : V1.1
 * Date               : 2024/11/14
...
#ifndef _WCH_NFCA_SOFT_PCD_CONFIG_H_
#define _WCH_NFCA_SOFT_PCD_CONFIG_H_
...
#define NFCA_PCD_DATA_BUF_SIZE                                  2048    /* NFC SOFT PCD信号数据缓存区大小配置，配置需要大，2048为较好的建议值 */
#endif
...
#endif  /* _WCH_NFCA_SOFT_PCD_CONFIG_H_ */
