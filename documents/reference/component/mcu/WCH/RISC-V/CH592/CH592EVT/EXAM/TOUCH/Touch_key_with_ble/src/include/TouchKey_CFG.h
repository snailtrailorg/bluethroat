...
#define TKY_CHS_INIT \
        ...
        GEN_TKY_CH_INIT(TKY_QUEUE_1,1,2,3,0,3393,74,59),\
        GEN_TKY_CH_INIT(TKY_QUEUE_2,5,2,3,0,3311,82,66),\
        GEN_TKY_CH_INIT(TKY_QUEUE_3,4,2,3,0,3300,71,56),\
        GEN_TKY_CH_INIT(TKY_QUEUE_4,3,2,3,0,3264,81,65),\
        GEN_TKY_CH_INIT(TKY_QUEUE_5,2,2,3,0,3331,77,61),\
        GEN_TKY_CH_INIT(TKY_QUEUE_6,9,2,3,0,3278,74,59),\
        GEN_TKY_CH_INIT(TKY_QUEUE_7,8,2,3,0,3278,79,65),\
