...
static uint8_t scanRspData[] = {
    ...
    'c', 'h', '5', '9', '2', '_', 'b', 'l', 'e', '_', 'i', 'o', 'c', 'h', 'u', 'b',
...
// GAP GATT Attributes
static uint8_t attDeviceName[GAP_DEVICE_NAME_LEN] = "CH592_ble_iochub";
