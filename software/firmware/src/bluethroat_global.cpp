...
const TaskParam_t g_TaskParam[] = { /**/
    ...
    [TASK_ID_DPS3XX_BAROMETER]   = {.task_name = "DPS3XX_BARO",  .task_stack_size = configMINIMAL_STACK_SIZE,    .task_priority = ((configMAX_PRIORITIES -  8) | portPRIVILEGE_BIT),     .task_core_id = TASK_CORE_1,    .task_interval = (pdMS_TO_TICKS(             50))},
    [TASK_ID_DPS3XX_ANEMOMETER]  = {.task_name = "DPS3XX_ANEMO", .task_stack_size = configMINIMAL_STACK_SIZE,    .task_priority = ((configMAX_PRIORITIES -  8) | portPRIVILEGE_BIT),     .task_core_id = TASK_CORE_1,    .task_interval = (pdMS_TO_TICKS(             50))},
};
